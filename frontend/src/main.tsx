...
const NotFound = () => (
  <div className="min-h-screen bg-[#141417] flex items-center justify-center text-center px-6">
    <div>
      ...
      <a href="/" className="inline-block px-8 py-3 bg-[#FF5A1F] text-white rounded-xl font-semibold text-lg hover:bg-[#E04D18] transition active:scale-95">Ana Sayfaya Dön</a>
    </div>
  </div>
)
