/**
 * Tuzla Pilot Bolge — 55+ Restoran Seed Data
 * Ogrenci-uygun fiyatlar, kampus yakini
 */
const TUZLA_RESTAURANTS = [
  {
    ...
    tags: ['pide', 'karadeniz', 'firin', 'ogrenci'],
    address: 'Merkez Mah. Sahil Cad. No:12, Tuzla, Istanbul',
    phone: '0216 395 10 01',
    competition_slots: [
      { slot: 'lunch', start: '11:00', end: '14:00' },
      { slot: 'dinner', start: '18:00', end: '22:00' }
    ],
    available_hours: { open: '10:00', close: '22:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    available_hours: { open: '10:00', close: '23:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['balik', 'deniz urunleri', 'meze', 'sahil', 'taze'],
    ...
    available_hours: { open: '11:00', close: '23:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['kokorec', 'sokak yemegi', 'gece', 'ogrenci'],
    address: 'Merkez Mah. Cumhuriyet Cad. No:8, Tuzla, Istanbul',
    phone: '0216 395 40 04',
    competition_slots: [
      { slot: 'lunch', start: '11:00', end: '14:00' },
      { slot: 'dinner', start: '18:00', end: '22:00' },
      { slot: 'late', start: '22:00', end: '02:00' }
    ],
    available_hours: { open: '11:00', close: '02:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['pizza', 'makarna', 'italyan', 'ogrenci'],
  ...
  },
  {
    ...
    tags: ['burger', 'amerikan', 'fast food', 'patates'],
    ...
    available_hours: { open: '11:00', close: '01:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['kahvalti', 'serpme', 'gozleme', 'menemen', 'bahce'],
    address: 'Aydinli Mah. Bahce Sok. No:7, Tuzla, Istanbul',
    phone: '0216 395 70 07',
    competition_slots: [
      { slot: 'breakfast', start: '07:00', end: '10:00' },
      { slot: 'lunch', start: '11:00', end: '14:00' }
    ],
    available_hours: { open: '07:00', close: '15:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['asya', 'noodle', 'wok', 'sushi', 'uzakdogu'],
    ...
    available_hours: { open: '11:30', close: '22:30', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['tatli', 'kunefe', 'baklava', 'sutlac', 'geleneksel'],
  ...
  },
  {
    ...
    tags: ['ev yemegi', 'tabldot', 'anne yemegi', 'ogrenci', 'ekonomik'],
    ...
    available_hours: { open: '10:30', close: '21:00', days: [1, 2, 3, 4, 5, 6] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['kebap', 'adana', 'urfa', 'mangal', 'odun atesi'],
    ...
    available_hours: { open: '11:00', close: '22:30', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['cafe', 'kahve', 'tost', 'sandvic', 'ogrenci', 'calisma'],
    ...
    available_hours: { open: '07:30', close: '22:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['cigkofte', 'durum', 'vegan', 'hafif', 'ogrenci'],
  ...
  },
  {
    ...
    tags: ['midye', 'balik ekmek', 'sokak yemegi', 'sahil', 'deniz'],
  ...
  },
  {
    ...
    tags: ['lahmacun', 'etli ekmek', 'ayran', 'hizli', 'ogrenci'],
    ...
    available_hours: { open: '10:30', close: '22:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['waffle', 'tatli', 'cikolata', 'ogrenci', 'meyve'],
    ...
    available_hours: { open: '12:00', close: '23:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['tantuni', 'mersin', 'durum', 'baharatli', 'hizli'],
  ...
  },
  {
    ...
    tags: ['borek', 'pogaca', 'kahvalti', 'hamur isi', 'geleneksel'],
    ...
    available_hours: { open: '06:30', close: '17:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['cag kebabi', 'erzurum', 'kebap', 'et', 'lavas'],
    ...
    available_hours: { open: '11:00', close: '22:00', days: [1, 2, 3, 4, 5, 6] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['tost', 'kumru', 'kasar', 'ogrenci', 'ekonomik'],
    ...
    available_hours: { open: '07:00', close: '02:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['balik', 'izgara', 'buharlama', 'taze', 'deniz', 'premium'],
  ...
  },
  {
    ...
    tags: ['corba', 'mercimek', 'iskembe', 'sicak', 'ekonomik'],
    ...
    available_hours: { open: '06:00', close: '02:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['mangal', 'izgara', 'kofte', 'pirzola', 'doga'],
    ...
    available_hours: { open: '11:00', close: '22:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['tavuk', 'citir', 'burger', 'nugget', 'fast food'],
    ...
    available_hours: { open: '10:00', close: '01:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['cafe', 'kahvalti', 'deniz manzara', 'kahve', 'brunch'],
    ...
    available_hours: { open: '07:00', close: '20:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['kumpir', 'patates', 'sokak yemegi', 'ogrenci', 'bol malzeme'],
  ...
  },
  {
    ...
    tags: ['ramen', 'japon', 'miso', 'gyoza', 'asya'],
    ...
    available_hours: { open: '11:30', close: '22:00', days: [1, 2, 3, 4, 5, 6] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['ciger', 'edirne', 'arnavut', 'tava', 'geleneksel'],
    ...
    available_hours: { open: '10:00', close: '21:00', days: [1, 2, 3, 4, 5, 6] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['pizza', 'dilim', 'ekonomik', 'italyan', 'ogrenci'],
  ...
  },
  {
    ...
    tags: ['kokorec', 'gece', 'baharatli', 'sokak yemegi', 'usta'],
    ...
    available_hours: { open: '16:00', close: '03:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['pide', 'kiymali', 'kasarli', 'tas firin', 'usta'],
  ...
  },
  {
    ...
    tags: ['smash burger', 'amerikan', 'milkshake', 'patates', 'gurme'],
    ...
    available_hours: { open: '11:00', close: '00:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['gozleme', 'koy', 'peynirli', 'geleneksel', 'ev yapimi'],
    ...
    available_hours: { open: '07:00', close: '18:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['dondurma', 'maras', 'tatli', 'sahil', 'serinletici'],
  ...
  },
  {
    ...
    tags: ['manti', 'kayseri', 'yogurt', 'ev yapimi', 'geleneksel'],
  ...
  },
  {
    ...
    tags: ['tavuk', 'sis', 'doner', 'ekonomik', 'hizli'],
  ...
  },
  {
    ...
    tags: ['simit', 'pogaca', 'cay', 'kahvalti', 'pratik'],
    ...
    available_hours: { open: '06:00', close: '20:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['thai', 'pad thai', 'curry', 'kutu', 'asya'],
  ...
  },
  {
    ...
    tags: ['kanat', 'tavuk', 'acili', 'bbq', 'fast food'],
  ...
  },
  {
    ...
    tags: ['balik', 'karides', 'kalamar', 'lokanta', 'aile'],
  ...
  },
  {
    ...
    tags: ['kahve', 'espresso', 'turk kahvesi', 'mola', 'sakin'],
    ...
    available_hours: { open: '07:00', close: '21:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['kofte', 'izgara', 'pilav', 'ekmek arasi', 'ekonomik'],
  ...
  },
  {
    ...
    tags: ['tatli', 'profiterol', 'trilece', 'dondurma', 'supangle'],
  ...
  },
  {
    ...
    tags: ['ev yemegi', 'gunluk menu', 'tabldot', 'sicak', 'anne eli'],
    ...
    available_hours: { open: '10:00', close: '20:30', days: [1, 2, 3, 4, 5, 6] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['wrap', 'falafel', 'tavuk', 'saglikli', 'hizli'],
    ...
    available_hours: { open: '09:00', close: '20:00', days: [1, 2, 3, 4, 5, 6] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['kebap', 'iskender', 'ali nazik', 'izgara', 'geleneksel'],
  ...
  },
  {
    ...
    tags: ['baklava', 'kunefe', 'katmer', 'gaziantep', 'fistik'],
  ...
  },
  {
    ...
    tags: ['kebap', 'kusbasi', 'sis', 'lahmacun', 'odun atesi'],
  ...
  },
  {
    ...
    tags: ['pasta', 'borek', 'pogaca', 'cay', 'pastane'],
    ...
    available_hours: { open: '06:30', close: '20:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['burger', 'cheese', 'sahil', 'amerikan', 'ekonomik'],
  ...
  },
  {
    ...
    tags: ['corba', 'pilav', 'nohut', 'ogrenci', 'ekonomik'],
  ...
  },
  {
    ...
    tags: ['cin', 'wok', 'spring roll', 'dumpling', 'asya'],
  ...
  },
  {
    ...
    tags: ['pizza', 'pasta', 'makarna', 'italyan', 'ekonomik'],
  ...
  },
  {
    ...
    tags: ['kahvalti', 'serpme', 'sahanda', 'sucuk', 'peynir'],
    ...
    available_hours: { open: '07:00', close: '16:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['doner', 'iskender', 'durum', 'et', 'tavuk'],
  ...
  },
  {
    ...
    tags: ['cigkofte', 'durum', 'nar eksi', 'hafif', 'vegan'],
  ...
  },
  {
    ...
    tags: ['pasta', 'cheesecake', 'tiramisu', 'brownie', 'cafe'],
    ...
    available_hours: { open: '10:00', close: '22:30', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['doner', 'kebap', 'pide', 'ogrenci menusu', 'ekonomik'],
  ...
  },
  {
    ...
    tags: ['karides', 'guvec', 'deniz urunleri', 'tava', 'ozel'],
  ...
  },
  {
    ...
    tags: ['gece', 'durum', 'kokorec', 'tost', 'late night'],
    ...
    available_hours: { open: '18:00', close: '04:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['izgara', 'mangal', 'kofte', 'pirzola', 'karisik'],
  ...
  },
  {
    ...
    tags: ['brunch', 'avokado', 'granola', 'kahve', 'modern'],
    ...
    available_hours: { open: '08:00', close: '18:00', days: [1, 2, 3, 4, 5, 6, 7] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['sushi', 'japon', 'sashimi', 'roll', 'taze'],
    ...
    available_hours: { open: '12:00', close: '22:30', days: [1, 2, 3, 4, 5, 6] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['ev yemegi', 'zeytinyagli', 'tabldot', 'cesitli', 'gunluk'],
    ...
    available_hours: { open: '10:00', close: '20:00', days: [1, 2, 3, 4, 5, 6] },
    is_active: 1,
    source: 'seed_tuzla'
  },
  {
    ...
    tags: ['cikolata', 'truffle', 'el yapimi', 'sicak cikolata', 'hediye'],
